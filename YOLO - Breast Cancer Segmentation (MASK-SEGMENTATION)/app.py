...
with st.sidebar:
    ...
    model_path = st.text_input("Model path", value="runs/segment/train2/weights/last.pt")
    st.caption("Tip: put your trained weights path here.")
    st.markdown("---")
